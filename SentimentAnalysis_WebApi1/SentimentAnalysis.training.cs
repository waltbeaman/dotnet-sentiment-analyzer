...
using Microsoft.ML;
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\uualt\source\data\IMDB Dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"review",outputColumnName:@"review")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.3161827F,L2Regularization=0.04098548F,LabelColumnName=@"sentiment",FeatureColumnName=@"Features"}))      
